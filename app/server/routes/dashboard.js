...
router.get("/summary", (req, res) => {
  ...
  const unreadNotifications = db.find("notifications", n => n.userId === req.userId && !n.read && n.type !== "recommendation-event").length;
  ...
  res.json({
    ...
    spendByCategory,
    unreadNotifications,
    transactionCount: db.find("transactions", t => t.userId === req.userId).length,
  });
});
